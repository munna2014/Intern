                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-black px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent outline-none transition-all"
                    />
                  </div>
                  <div>
                    <label className="block font-bold text-gray-700 mb-2">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-green-600 to-emerald-600 rounded-2xl shadow-lg p-6 text-white">
                ...
                <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 mb-4">
                  ...
                  <div className="text-xs text-white/80">250 points to go</div>
                </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              {addresses.map((address, index) => (
                <div
                  key={index}
                  className="bg-white rounded-2xl shadow-sm p-6 border-2 border-gray-200 hover:border-green-600 transition-colors relative"
                >
                  {address.isDefault && (
                  ...
                  <div className="flex gap-3 mt-4 pt-4 border-t">
                    ...
                    <button className="flex-1 px-4 py-2 border border-red-300 text-red-600 rounded-lg hover:bg-red-50 transition-colors font-medium">
                      Delete
                    </button>
                  </div>
                </div>
